...
from gpsr_semantic_parser.grammar import prepare_grounded_rules, tree_printer
...
cat1_rules = prepare_grounded_rules(common_path, join(grammar_dir, "gpsr_category_1_grammar.txt"), *paths)
cat2_rules = prepare_grounded_rules(common_path, join(grammar_dir, "gpsr_category_2_grammar.txt"), *paths)
cat3_rules = prepare_grounded_rules(common_path, join(grammar_dir, "gpsr_category_3_grammar.txt"), *paths)
